<template>
  ...
  >
    <UButton
      :variant="$route.name === 'index' ? 'solid' : 'ghost'"
      icon="i-line-md-file-document"
      :to="{ name: 'index' }"
      @click="$emit('nav')"
      label="Resume"
    />
    ...
    <UButton
      ...
      to="mailto:tremorrisdev@gmail.com"
      @click="$emit('nav')"
      label="Email"
    />
    <UButton
      ...
      to="https://github.com/tremorrisdev"
      @click="$emit('nav')"
      label="Github"
    />
    <UButton
      ...
      to="https://www.linkedin.com/in/trevor-a-morris/"
      @click="$emit('nav')"
      label="LinkedIn"
    />
  </div>
